	...
	<ul class="nav nav-list">
		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="<c:url value="/chi-tiet-san-pham/${ product.productID }"/>"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value ="/assets/user/watch/${ product.image }"/>"
							alt="bootstrap ecommerce templates">
						<div class="caption">
							<h4>
								<a class="shopBtn" href="<c:url value="/add-cart/${ product.productID }"/>">Thêm</a> <span
									class="pull-right"><fmt:formatNumber
															type="number" groupingUsed="true"
															value="${ product.price *(100-product.sale)/100 }" />đ</span>
							</h4>
						</div>
					</div>
				</li>
